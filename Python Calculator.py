# The Python Calculator Made From Scratch
# Developers: Niloy Rashid ( @niloyrashidofficial ) and George ( @loop.pe )
...
me=Tk()
me.geometry("354x460")
me.title("PythonCalculator")
melabel = Label(me,text="Python Calculator",bg='White',font=("Times",30,'bold'))
